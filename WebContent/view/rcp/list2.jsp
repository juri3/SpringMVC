		...
		<div class="card">
			...
			<div class="card-header">
				...
				<div class="card-header-is_closed">
					...
					<div class="card-header-text">rcp1</div>
			...
			<div class="card-body">
				...
				<div class="card-body-header">
					...
					<p class="card-body-hashtag">#tofu #두부두부 #두부두부두부</p>

					<p class="card-body-nickname">작성자: memNum el로 들어가겠지</p>

				</div>

				<p class="card-body-description">몸에 좋은 두부</p>
				...
				<div class="card-body-footer">
					...
					<i class="icon icon-view_count"></i>조회수 넣지말자고 했었지? <i
						class="icon icon-comments_count"></i>댓글기능 구현하고싶다 <i
						class="reg_date"> 2020/03/15 </i>
